...
@dag(
    dag_id = "10_schedule_delta_dag",
    start_date = pendulum.datetime(2023, 1, 1, 10, 0, tz="Asia/Singapore"),  # anchor at 10:00 SGT
    schedule = DeltaTriggerTimetable(timedelta(days=3)),  # every 3 days, at the start_date's time-of-day
    catchup = False,

...
@dag(
    dag_id="11_incremental_load_dag",
    schedule=CronDataIntervalTimetable("@daily",timezone="America/Halifax"),
    start_date=datetime(year=2026, month=9, day=10, tz="America/Halifax"),
    end_date=datetime(year=2026, month=9, day=30, tz="America/Halifax"),
    catchup=True,
